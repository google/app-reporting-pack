...
CREATE OR REPLACE TABLE {bq_project}.{target_dataset}.geo_performance
AS (
    SELECT
    ...
    FROM {bq_project}.{bq_dataset}.geo_performance AS GP
    LEFT JOIN {bq_project}.{bq_dataset}.geo_performance_conversion_split AS ConversionSplit
